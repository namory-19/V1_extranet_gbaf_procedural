...
<body>
    ...
    <section class="home_bloc_actors">
        <div class="home_bloc_actors_container">
            <div class="home_logo_bloc_actors">
                <img src="img/logo_protectpeople.png" alt="logo Protect People">
            </div>
            <div class="home_text_bloc_actors">
                <h3>
                    Protect People
            ...
            <div class="home_read_more_bloc_actors">
            <a href="/" target="_blank" rel="noopener noreferrer"><div class="home_read_more_bloc_actors_button">Lire la suite</div></a>   
            </div>
        </div>
    </section>
    <section class="home_bloc_actors">
        <div class="home_bloc_actors_container">
            <div class="home_logo_bloc_actors">
                <img src="img/logo_dsa_france.png" alt="logo DSA France">
            </div>
            <div class="home_text_bloc_actors">
                <h3>
                    DSA France
    ...
    <section class="home_bloc_actors">
        <div class="home_bloc_actors_container">
            <div class="home_logo_bloc_actors">
                <img src="img/logo_cde.png" alt="logo DSA France">
            </div>
            <div class="home_text_bloc_actors">
                <h3>
                    CDE
